...
def execute(filters=None):
	...
	#	total_wbt_net_weight += (d.wbt_net_weight)
		...
		data.append([
			...
			d.vt_location,d.vt_rate,d.vt_other_charges,d.vt_other_charges_amount,d.Total
		])
...
def get_columns(filters):
	...
	return [
		_("Date") + ":Date:140",
		_("Challan Number") + ":Link/Vishal Transport Bill Report:140",
		_("Party Information") + ":Link/Vishal Transport Bill Report:140",
		_("Delivery Type") + ":Link/Vishal Transport Bill Report:140",
		_("Location") + ":Link/Vishal Transport Bill Report:140",
		_("Rate") + ":Int:80",
		_("Other Charges") + ":Link/Vishal Transport Bill Report:140",
		_("Other Charges Amount") + ":Int:80",
		_("Total") + ":Float:140"]
...
def get_entries(filters):
	...
	entries = frappe.db.sql("""
		select
			...
			vt.vt_location,vt.vt_rate,vt.vt_other_charges,vt.vt_other_charges_amount,vt.vt_rate+vt.vt_other_charges_amount as Total
		from  
